...
<head>
    <meta charset="UTF-8">
    <title>Barbershop - Категории услуг</title>
    <link rel="icon" href="/Resources/Images/Icons/Logo.png">
    <link rel="stylesheet" href="/CSS/Pages/Main.css">
    <link rel="stylesheet" href="/CSS/Pages/CategoriesService.css">
...
<div class="main">
    ...
    <div class="content">
        <?php if(Access::isAdministrator()): ?>
            ...
            <?php include $_SERVER["DOCUMENT_ROOT"] . "/Views/Renders/TableCategoriesService.php"; ?>
        <?php endif; ?>
    </div>
